...
public class ImageBucketAdapter extends BaseAdapter {
	...
	public ImageBucketAdapter(Activity act, List<AlbumEntity> list) {
		this.act = act;
		dataList = list;
	...
	public View getView(int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			holder = new Holder();
			arg1 = View.inflate(act, R.layout.gridview_item_album_bucket, null);
		...
		AlbumEntity item = dataList.get(arg0);
