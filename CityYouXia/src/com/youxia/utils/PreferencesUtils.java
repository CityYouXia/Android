...
public class PreferencesUtils {
    ...
    public static String PREFERENCE_NAME = "KEAndroidCommon";		//Preferences名字
    private static int  preferencemode = Context.MODE_PRIVATE;		//Preferences模式
     ...
     * 
     */
    public static void setPreferenceMode(int mode)
    {
    	preferencemode = mode;
    }
    ...
    public static boolean putString(Context context, String key, String value) {
        SharedPreferences settings = context.getSharedPreferences(PREFERENCE_NAME, preferencemode);
