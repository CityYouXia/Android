...
public class PhotoDetailsActivity extends BaseActivity {
	...
	@ViewInject(id=R.id.activity_photo_details_rl,click="btnClick")		RelativeLayout		photo_relativeLayout;
	@ViewInject(id=R.id.activity_photo_details_exit,click="exit")		Button				photo_bt_exit;
	@ViewInject(id=R.id.activity_photo_details_del,click="btnClick")	Button				photo_bt_del;
	@ViewInject(id=R.id.activity_photo_details_enter,click="btnClick")	Button				photo_bt_enter;
